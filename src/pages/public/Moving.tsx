          ...
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            >
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Clearing out after the move? We haul away furniture, appliances, and debris — fast and affordable.
              </p>
            ...
            >
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Renovating your new place? We handle the teardown — walls, decks, cabinets, flooring — and remove the debris.
              </p>
              <span className="inline-flex items-center gap-1 text-orange-500 font-semibold text-sm mt-4">
                Learn more <ArrowRight className="w-4 h-4" />
              </span>
